...
This code notebook provides a fully reproducible workflow for the paper 'Playful iconicity'. To increase readability, not all code chunks present in the .Rmd source are shown in the output. 
...
list.of.packages <- c("knitr","kableExtra","stringr","tidyverse","GGally","ggthemes","readxl","ggrepel","ppcor","stringr","car","lme4","mgcv","cowplot","flextable","effsize")
