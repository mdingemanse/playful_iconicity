...
```{r plots}
cor.test(df$freq_log,df$humor)
ggplot(df,aes(freq_log,humor)) +
  geom_point(alpha=0.5) +
  geom_smooth(method="loess")
ggsave(file="out/humor_by_logfreq.png",width=6,height=4)

cor.test(df$iconicity,df$humor)
...
ggplot(df %>% filter(iconicity > 0),aes(iconicity,humor)) +
  geom_point(alpha=0.5) +
  geom_smooth(method="loess")
ggsave(file="out/humor_by_pos_iconicity.png",width=6,height=4)
```
